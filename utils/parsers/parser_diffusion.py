...
def parse_args():
    ...
    parser.add_argument('--head_dropout', type=float, help='head dropout rate')
    ...
    parser.add_argument('--k_z', type=float, help='KL weight')
    parser.add_argument('--k_cond', type=float, help='Condition weight')
    parser.add_argument('--d_z', type=int, help='KL weight')
    ...
    parser.add_argument('--diffusion_config_dir', type=str, help='path to diffusion config file')
    
    # parser.add_argument('--cond_pred_model_dir', type=str, default='./checkpoints/cond_pred_model_pertrain_NS_Transformer/checkpoint.pth', help='')
    parser.add_argument('--cond_pred_model_pertrain_dir', type=str, help='path to pretrained condition prediction model')
    parser.add_argument('--CART_input_x_embed_dim', type=int, help='feature dim for x in diffusion model')
    parser.add_argument('--mse_timestep', type=int, help='MSE timestep')    
    parser.add_argument('--MLP_diffusion_net', type=bool, help='use MLP or Unet in diffusion model')
