...
parser.add_argument('--root_path', type=str, default='/home/yl2428/Time-LLM/dataset/ETT-small', help='root path of the data file')
...
for ii in range(args.itr):
    ...
    # add time to path
    path = os.path.join(path, time.strftime('%Y-%m-%d-%H-%M-%S'))
